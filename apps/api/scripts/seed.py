...
FIRST_NAMES = [
    "Aanya", "Aarav", "Aisha", "Akira", "Alex", "Amelia", "Ananya", "Ankit",
    "Arjun", "Asha", "Avery", "Ben", "Cameron", "Carlos", "Chen", "Chloe",
    "Daniel", "Deepak", "Eli", "Emma", "Ethan", "Fatima", "Gabriel", "Grace",
    "Hannah", "Hari", "Hassan", "Imani", "Isabella", "Ishan", "Jack", "James",
    "Jasmine", "Kai", "Karthik", "Kavya", "Kiran", "Lakshmi", "Leo", "Liam",
    "Mei", "Meera", "Mia", "Mohammed", "Nadia", "Naman", "Naomi", "Neha",
    "Noah", "Olivia", "Oscar", "Pooja", "Priya", "Rahul", "Raj", "Riya",
    "Sara", "Shreya", "Sofia", "Sophia", "Tara", "Uma", "Vikram", "Wei",
    "William", "Yara", "Yuki", "Zara",
]

LAST_NAMES = [
    "Adams", "Agarwal", "Ahmed", "Allen", "Anand", "Andrews", "Bhatt",
    "Brown", "Chakraborty", "Chen", "Clark", "Cooper", "Das", "Davies",
    "Davis", "Desai", "Edwards", "Evans", "Foster", "Garcia", "Ghosh",
    "Gupta", "Harris", "Hassan", "Iyer", "Jain", "Johnson", "Jones",
    "Kapoor", "Kaur", "Khan", "Kim", "Krishnan", "Kumar", "Kim", "Lee",
    "Li", "Lewis", "Liu", "Lopez", "Malhotra", "Martin", "Mehta", "Miller",
    "Mitra", "Mohan", "Nair", "Nakamura", "Nguyen", "OBrien", "Park",
    "Patel", "Peters", "Pillai", "Prasad", "Rao", "Reddy", "Rodriguez",
    "Sen", "Shah", "Sharma", "Singh", "Smith", "Sundaram", "Sutton",
    "Taylor", "Thomas", "Verma", "Walker", "Wang", "Williams", "Wilson",
...
def seed_levels(conn: Connection) -> dict[int, int]:
    for code, rank in LEVELS:
        conn.execute(
            text(
                "INSERT INTO levels (code, rank) VALUES (:code, :rank) "
